     ...
     <aside id="sidebar_main">
        ...
        <div class="menu_section">
            <ul>
				...
				<li title="Dashboard">
                    <?php 
								$sqlseller1 = $db->query("SELECT * FROM company WHERE cumpanyUserCode = '$thisid'");
										...
										while($row = mysqli_fetch_array($sqlseller1)) 
											{
												...
												$sqlinfo = $db->query("SELECT * FROM levels WHERE id = '$levelCode' LIMIT 1");
                                                while($arrayinfo = mysqli_fetch_array($sqlinfo))
                                                {
                                                    $parentId = $arrayinfo['parentId'];
                ...
                <li title="Dashboard">
                    <a href="#">
                        ...
                        <span class="menu_title">Messeges </span>
                    </a>
                </li>
            </ul>
        </div>
